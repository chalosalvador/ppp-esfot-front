...
const TeacherForm = (props) => {
    ...
    return(
        !props.edit?
            (
                <Form onFinish={addTeacher} {...formItemLayout}>
                    <Form.Item name='faculty_id' label='Facultad' rules={ [
                        ...
                        <Select placeholder='Selecciona una facultad' onChange={ handleChangeFaculty } onClear={ handleChangeFaculty } loading={ isLoading }>
                    ...
                    <Form.Item name="name" label="Nombre" rules={[{required: true, message:"Ingresa su nombre."}]}>
                        <Input />
                    </Form.Item>
                    <Form.Item name="lastname" label="Apellido" rules={[{required: true, message:"Ingresa su apellido."}]}>
                        <Input />
                    </Form.Item>
                    <Form.Item name="degree" label="Título" rules={[{required: true, message:"Ingresa su título."}]}>
                        <Input/>
                    </Form.Item>
                    <Form.Item name="email" label="Email" rules={[{required: true, message:"Ingresa su email."}]}>
                        <Input />
                    </Form.Item>
                    <Form.Item name="phone" label="Teléfono" rules={[{required: true, message:"Ingresa su numero de teléfono convencional."}]}>
                        <Input />
                    </Form.Item>
                    <Form.Item name="mobile" label="Celular" rules={[{required: false, message:"Ingresa su número de teléfono celular."}]}>
                        <Input />
                    </Form.Item>
                    <Form.Item
                        name="sex"
            ...
            (
                <Form {...formItemLayout} onFinish={editTeacher} initialValues={{
