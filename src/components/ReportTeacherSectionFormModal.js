...
import ReportTeacherSectionForm from './ReportTeacherSectionForm';

const { confirm } = Modal;

const ReportTeacherSectionFormModal = ( { internshipId, report } ) => {
    ...
    confirm( {
        ...
        onOk: async() => {
          ...
          try {
            ...
            await API.post( `/internships/${ report.internship_id }/internship-reports/${ report.id }/tutor`, values );
  ...
  return (
    <>
      ...
      <Modal
        ...
        onOk={ () => form.submit() }>
        <ReportTeacherSectionForm form={ form } onSubmit={ handleComplete } internshipId={ internshipId } />
      </Modal>
    </>
  );
};

export default ReportTeacherSectionFormModal;
