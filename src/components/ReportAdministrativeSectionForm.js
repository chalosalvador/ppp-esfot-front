  ...
  return (
    ...
    >
      <Form.Item name='commission_approves'
        ...
        <Radio.Group onChange={ ( e ) => setCommissionApproves( e.target.value ) } buttonStyle='solid'>
      ...
      {
        !commissionApproves &&
        <Form.Item name='set_status_to' label='Observaciones para:' rules={ [
          {
            required: true,
            message: 'Indica que persona debe realizar correcciones en el informe.',
          }
        ] }>
      ...
      <Form.Item name='commission_observations' label='Observaciones' rules={ [
        {
          required: !commissionApproves,
          whitespace: true,
          message: 'Debes indicar la razón por la que no se debe aprobar este informe.',
        },
        {
          min: 40,
