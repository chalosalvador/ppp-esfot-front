  ...
  return (
    <>
      <Descriptions title={ <Divider orientation='center'><strong>REPORTE DE LA EMPRESA</strong></Divider> }
        ...
        <Descriptions.Item label='Observaciones' span={ 2 }>{ internship.evaluation_observations }</Descriptions.Item>
      </Descriptions>
      ...
      <Modal
        ...
        onOk={ () => form.submit() }>
        <ReportRepresentativeSectionForm form={ form } onSubmit={ handleSendReport } internship={ internship } />
      </Modal>
    </>
  );
};
